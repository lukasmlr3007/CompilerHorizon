...
public class ClassBytecode implements ClassBytecodeVisitor {
    ...
    public void visit(FieldDecl field) {
        classWriter.visitField(field.accessModifierToOpcode(field.getAccessModifier()) + field.staticToOpcode(field.getIsStatic()), field.getIdentifier(), field.fieldTypeToDescriptor(field.getType()), null, null).visitEnd();
    }
}
