...
public class JavaGrammerParser extends Parser {
	...
	public static final int
		...
		Void=10, While=11, If=12, Else=13, New=14, This=15, AccessModifier=16, 
		OpenCurlyBracket=17, ClosedCurlyBracket=18, OpenRoundBracket=19, ClosedRoundBracket=20, 
		Semicolon=21, Comma=22, Point=23, Return=24, LogicOperator=25, RelationalOperator=26, 
		AdditiveOperator=27, Identifier=28, IntValue=29, BoolValue=30, CharValue=31, 
		WS=32;
	public static final int
	...
	public final ConstructorContext constructor() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 268437376L) != 0)) {
				{
				setState(90);
				parameters();
				}
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 285400960L) != 0)) {
				{
				{
				setState(108);
				statement();
	...
	public final ReturnStatementContext returnStatement() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 4027105282L) != 0)) {
				{
				setState(178);
				expression();
				}
